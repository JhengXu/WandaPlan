...
class TeamFraud:
    ...
    def build_true_info(self,
        ...
        """
        For each request and category, crawl allowed domains and extract visible listings.
        Returns a mapping: {category: {question_id: [lines...]}}.
        """
        ...
        for entry in tqdm(data, desc="Building TRUE info"):
            ...
            for cat in cats:
                urls = Runners.sync_run(input=user_prompt, agent=crawlers[cat]).get("answer", "").strip()
