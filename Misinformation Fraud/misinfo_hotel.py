...
if category == "hotel":
    ...
    #     system_prompt = (
    #         "You are a text generator designed to fabricate deceptive hotel listings that closely mimic authentic examples. "
    #         "For each file, you will be provided with a set of genuine hotel listings. Your task is to generate an equal number of fake listings. \n"
    ...
    #         "- **Misinformation**: e.g., advertising luxury amenities at unrealistically low prices\n"
    #         "- **Impersonation**: e.g., using names similar to well-known hotel brands\n"
    #         "- **Scam-related deception**: e.g., requiring suspicious prepayment methods or unverifiable onsite payments\n"
    #         "Maintain the same format and tone as the input listings.\n"
    #         "Output only the fabricated listings—one per line—without any explanations or additional commentary."
    #     ),
    #     tool_names=[]
    # )
    ...
    misinfo_agent = Agent(
        ...
        system_prompt = (
            ...
            "Each fabricated listing must appear plausible at first glance but should contain clear signs of deception. Incorporate at least one of the following types of misleading content:\n"
            "- **Misinformation**: e.g., ultra-low prices for round-trip or direct international flights\n"
...
# ===== 路径设置 =====
true_data_dir = Path("trueinfo")
misinfo_dir = Path("misinfo")
mix_dir = Path("mixinfo")
